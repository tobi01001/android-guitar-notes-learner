...
class NoteRecognizer {
     ...
     */
    private fun calculateCents(actualMidi: Double, targetMidi: Int): Double {
     ...
     */
    fun matchesNote(detectedFrequency: Double, expectedNoteName: String): Boolean {
     ...
     */
    fun getNoteFrequency(noteName: String, octave: Int = 4): Double {
